...
const translations = {
  pt: {
    ...
    'pricing.pack4': 'Pacote 4 unidades',
    'pricing.pack6': 'Pacote 6 unidades',
  ...
  en: {
    ...
    'pricing.pack4': '4-piece pack',
    'pricing.pack6': '6-piece pack',
  ...
  de: {
    ...
    'pricing.pack4': '4er-Pack',
    'pricing.pack6': '6er-Pack',
