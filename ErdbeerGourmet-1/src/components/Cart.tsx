            ...
            <div className="border-t border-gray-200 px-6 py-4">
              ...
              <div className="space-y-2">
                <button
                  ...
                  disabled={isLoading}
                  className="w-full rounded-md bg-red-600 px-4 py-3 text-white font-medium hover:bg-red-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
                >
